(window.webpackJsonp = window.webpackJsonp || []).push([
  ...
  [
    function (e, t, i) {
      ...
      function F(e) {
        return "html" === x(e) ? e : e.assignedSlot || e.parentNode || (N(e) ? e.host : null) || q(e);
      }
      function $(e) {
        return P(e) && "fixed" !== R(e).position ? e.offsetParent : null;
      }
      function W(e) {
        for (var t = L(e), i = $(e); i && B(i) && "static" === R(i).position; ) i = $(i);
        return i && ("html" === x(i) || ("body" === x(i) && "static" === R(i).position))
          ? t
          : i ||
              (function (e) {
                var t = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                if (-1 !== navigator.userAgent.indexOf("Trident") && P(e) && "fixed" === R(e).position) return null;
                for (var i = F(e); P(i) && ["html", "body"].indexOf(x(i)) < 0; ) {
                  var s = R(i);
                  if (
                    "none" !== s.transform ||
                    "none" !== s.perspective ||
      ...
      var J = {
          ...
          fn: function (e) {
            ...
            if (u && h) {
              var f = (function (e, t) {
                  return X("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, { placement: t.placement })) : e) ? e : Q(e, c));
                })(l.padding, i),
                g = j(u),
                b = "y" === p ? n : a,
                y = "y" === p ? o : r,
                v = i.rects.reference[m] + i.rects.reference[p] - h[p] - i.rects.popper[m],
                w = h[p] - i.rects.reference[p],
                _ = W(u),
                k = _ ? ("y" === p ? _.clientHeight || 0 : _.clientWidth || 0) : 0,
                T = v / 2 - w / 2,
                E = f[b],
                C = k - g[m] - f[y],
                A = k / 2 - g[m] / 2 + T,
                S = Y(E, A, C),
                x = p;
              i.modifiersData[s] = (((t = {})[x] = S), (t.centerOffset = S - A), t);
            }
          },
          effect: function (e) {
            var t = e.state,
      ...
      function Z(e) {
        ...
        if (d) {
          var E = W(i),
            C = "clientHeight",
            A = "clientWidth";
          E === L(i) && "static" !== R((E = q(i))).position && ((C = "scrollHeight"), (A = "scrollWidth")),
            (E = E),
        ...
        return h
          ? Object.assign(
              ...
              (((S = {})[k] = w ? "0" : ""),
              (S[_] = v ? "0" : ""),
              (S.transform = (T.devicePixelRatio || 1) < 2 ? "translate(" + g + "px, " + y + "px)" : "translate3d(" + g + "px, " + y + "px, 0)"),
              S)
            )
          : Object.assign({}, x, (((t = {})[k] = w ? y + "px" : ""), (t[_] = v ? g + "px" : ""), (t.transform = ""), t));
      }
      var ee = {
          name: "computeStyles",
          enabled: !0,
          ...
          fn: function (e) {
            var t = e.state,
              ...
              a = i.roundOffsets,
              l = void 0 === a || a,
              c = { placement: M(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: n };
            null != t.modifiersData.popperOffsets &&
              (t.styles.popper = Object.assign(
                {},
                t.styles.popper,
                Z(Object.assign({}, c, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: r, roundOffsets: l }))
              )),
      ...
      function ue(e, t) {
        ...
        void 0 === t && (t = []);
        var s = (function e(t) {
            return ["html", "body", "#document"].indexOf(x(t)) >= 0 ? t.ownerDocument.body : P(t) && ce(t) ? t : e(F(t));
          })(e),
          ...
          ? he(
              (function (e) {
                var t = L(e),
                  ...
                  a = 0;
                return (
                  s && ((n = s.width), (o = s.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((r = s.offsetLeft), (a = s.offsetTop))),
          ...
          : he(
              (function (e) {
                var t,
                  ...
                  o = V(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
                  r = V(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
                  a = -s.scrollLeft + le(e),
                  l = -s.scrollTop;
                return "rtl" === R(n || i).direction && (a += V(i.clientWidth, n ? n.clientWidth : 0) - o), { width: o, height: r, x: a, y: l };
              })(q(e))
            );
      }
      function pe(e, t, i) {
        var s =
            "clippingParents" === t
              ? (function (e) {
                  var t = ue(F(e)),
                    i = ["absolute", "fixed"].indexOf(R(e).position) >= 0 && P(e) ? W(e) : e;
                  return O(i)
                    ? t.filter(function (e) {
          ...
          r = n.reduce(function (t, i) {
            var s = de(e, i);
            return (t.top = V(s.top, t.top)), (t.right = U(s.right, t.right)), (t.bottom = U(s.bottom, t.bottom)), (t.left = V(s.left, t.left)), t;
          }, de(e, o));
      ...
      function ge(e, t) {
        ...
        var i = t,
          ...
          L = I(C),
          P = fe({ reference: L, element: A, strategy: "absolute", placement: a }),
          N = he(Object.assign({}, A, P)),
          D = y === m ? N : L,
          M = { top: x.top - D.top + T.top, bottom: D.bottom - x.bottom + T.bottom, left: x.left - D.left + T.left, right: D.right - x.right + T.right },
          ...
          if (!t.modifiersData[s]._skip) {
            for (
                    ...
                    M(i) === l
                      ? (function (e, t) {
                          ...
                          var m = p.reduce(function (t, i) {
                            return (t[i] = ge(e, { placement: i, boundary: n, rootBoundary: o, padding: r })[M(i)]), t;
                          }, {});
                          return Object.keys(m).sort(function (e, t) {
                            return m[e] - m[t];
                          });
                        })(t, { placement: i, boundary: v, rootBoundary: w, padding: y, flipVariations: T, allowedAutoPlacements: E })
                      : i
                  );
                }, []),
                L = t.rects.reference,
              ...
              var j = x[I],
                ...
                B = [n, o].indexOf(H) >= 0,
                q = B ? "width" : "height",
                F = ge(t, { placement: j, boundary: v, rootBoundary: w, altBoundary: _, padding: y }),
                $ = B ? (R ? r : a) : R ? o : n;
              L[q] > O[q] && ($ = ne($));
              var W = ne($),
                z = [];
      ...
      function ye(e, t, i) {
        return (
          void 0 === i && (i = { x: 0, y: 0 }), { top: e.top - t.height - i.y, right: e.right - t.width + i.x, bottom: e.bottom - t.height + i.y, left: e.left - t.width - i.x }
        );
      }
      function ve(e) {
      ...
      var we = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            u = ve(l),
            h = ve(c);
          (t.modifiersData[i] = { referenceClippingOffsets: l, popperEscapeOffsets: c, isReferenceHidden: u, hasPopperEscaped: h }),
            (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": u, "data-popper-escaped": h }));
        },
      };
      var _e = {
        name: "offset",
              ...
              return (
                (e[i] = (function (e, t, i) {
                  var s = M(e),
                    ...
                    c = l[0],
                    u = l[1];
                  return (c = c || 0), (u = (u || 0) * o), [a, r].indexOf(s) >= 0 ? { x: u, y: c } : { x: c, y: u };
                })(i, t.rects, l)),
                e
              );
            }, {}),
      ...
      var ke = {
        ...
        fn: function (e) {
          var t = e.state,
            i = e.name;
          t.modifiersData[i] = fe({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
        },
        data: {},
      };
      var Te = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            v = i.tetherOffset,
            w = void 0 === v ? 0 : v,
            _ = ge(t, { boundary: p, rootBoundary: m, padding: g, altBoundary: f }),
            k = M(t.placement),
            T = me(t.placement),
            E = !T,
            C = z(k),
          ...
          if (S) {
            if (c || d) {
              var N = "y" === C ? n : a,
                ...
                se = ie ? ("y" === C ? ie.clientTop || 0 : ie.clientLeft || 0) : 0,
      ...
      function Ee(e, t, i) {
        ...
        return (
          (a || (!a && !i)) &&
            (("body" !== x(t) || ce(o)) && (l = (s = t) !== L(s) && P(s) ? { scrollLeft: (n = s).scrollLeft, scrollTop: n.scrollTop } : ae(s)),
            P(t) ? (((c = I(t)).x += t.clientLeft), (c.y += t.clientTop)) : o && (c.x = le(o))),
            ...
            u = {
              ...
              setOptions: function (i) {
                h(),
                  ...
                  (a.scrollParents = { reference: O(e) ? ue(e) : e.contextElement ? ue(e.contextElement) : [], popper: ue(t) });
                var n = (function (e) {
                  var t = Ce(e);
              ...
              forceUpdate: function () {
                if (!c) {
                  var e = a.elements,
                    ...
                    i = e.popper;
                  if (Se(t, i)) {
                    (a.rects = { reference: Ee(t, W(i), "fixed" === a.options.strategy), popper: j(i) }),
                      (a.reset = !1),
                    ...
                    for (var s = 0; s < a.orderedModifiers.length; s++)
                      if (!0 !== a.reset) {
                        var n = a.orderedModifiers[s],
                          ...
                          l = void 0 === r ? {} : r,
                          h = n.name;
                        "function" == typeof o && (a = o({ state: a, options: l, name: h, instance: u }) || a);
                      } else (a.reset = !1), (s = -1);
                  }
                }
              },
      ...
      const Ne = (e) => {
              ...
              r =
                o && Re(o)
                  ...
                  : {}.toString
                      ...
                      .toLowerCase();
            var a;
            if (!new RegExp(n).test(r)) throw new TypeError(e.toUpperCase() + ": " + `Option "${s}" provided type "${r}" ` + `but expected type "${n}".`);
          });
        },
        Fe = (e) => {
          if (!e) return !1;
        ...
        Ye = (e, t) => {
          ...
          (i = () => {
            ...
            if (i) {
              const s = i.fn[e];
              (i.fn[e] = t.jQueryInterface), (i.fn[e].Constructor = t), (i.fn[e].noConflict = () => ((i.fn[e] = s), t.jQueryInterface));
            }
          }),
      ...
      function lt(e, t, i, s, n) {
            ...
            ? (function (e, t, i) {
                return function s(n) {
                  ...
                  for (let { target: t } = n; t && t !== this; t = t.parentNode)
                    for (let r = o.length; r--; ) if (o[r] === t) return (n.delegateTarget = t), s.oneOff && ut.off(e, n.type, i), i.apply(t, [n]);
                  return null;
                };
              })(e, i, s)
            : (function (e, t) {
        ...
        (d.delegationSelector = o ? i : null), (d.originalHandler = r), (d.oneOff = n), (d.uidEvent = h), (c[h] = d), e.addEventListener(a, d, o);
      }
      ...
      const ut = {
        ...
        trigger(e, t, i) {
          ...
          let a,
            ...
            h = null;
          return (
            o && s && ((a = s.Event(t, i)), s(e).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (u = a.isDefaultPrevented())),
            r ? ((h = document.createEvent("HTMLEvents")), h.initEvent(n, l, !0)) : (h = new CustomEvent(t, { bubbles: l, cancelable: !0 })),
            void 0 !== i &&
      ...
      class ht {
        constructor(e) {
          (e = "string" == typeof e ? document.querySelector(e) : e) && ((this._element = e), Qe.set(this._element, this.constructor.DATA_KEY, this));
        }
        dispose() {
          Qe.remove(this._element, this.constructor.DATA_KEY), (this._element = null);
        }
      ...
      class dt extends ht {
        ...
        _destroyElement(e) {
          e.parentNode && e.parentNode.removeChild(e), ut.trigger(e, "closed.bs.alert");
        }
      ...
      ut.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', dt.handleDismiss(new dt())), Ye("alert", dt);
      class pt extends ht {
        static get DATA_KEY() {
          return "bs.button";
        }
      ...
      const gt = {
          ...
          getDataAttributes(e) {
            ...
            return (
              Object.keys(e.dataset)
                ...
                .forEach((i) => {
                  let s = i.replace(/^bs/, "");
                  (s = s.charAt(0).toLowerCase() + s.slice(1, s.length)), (t[s] = mt(e.dataset[i]));
                }),
              t
            );
          },
        ...
        yt = ".bs.carousel",
        vt = { interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0 },
        wt = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean", touch: "boolean" },
        _t = "next",
        kt = "prev",
        Tt = "left",
        Et = "right",
      ...
      class St extends ht {
        constructor(e, t) {
          super(e),
            ...
            (this._indicatorsElement = bt.findOne(".carousel-indicators", this._element)),
        ...
        pause(e) {
          e || (this._isPaused = !0),
            bt.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (He(this._element), this.cycle(!0)),
        ...
        to(e) {
          this._activeElement = bt.findOne(".active.carousel-item", this._element);
        ...
        _addEventListeners() {
          this._config.keyboard && ut.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
            "hover" === this._config.pause &&
              (ut.on(this._element, "mouseenter.bs.carousel", (e) => this.pause(e)), ut.on(this._element, "mouseleave.bs.carousel", (e) => this.cycle(e))),
          ...
          const e = (e) => {
            ...
            i = (e) => {
              !this._pointerEvent || ("pen" !== e.pointerType && "touch" !== e.pointerType) || (this.touchDeltaX = e.clientX - this.touchStartX),
                this._handleSwipe(),
                "hover" === this._config.pause &&
                  (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), (this.touchTimeout = setTimeout((e) => this.cycle(e), 500 + this._config.interval)));
            };
        ...
        _keydown(e) {
          /input|textarea/i.test(e.target.tagName) ||
            ("ArrowLeft" === e.key ? (e.preventDefault(), this._slide(Tt)) : "ArrowRight" === e.key && (e.preventDefault(), this._slide(Et)));
        }
        _getItemIndex(e) {
          return (this._items = e && e.parentNode ? bt.find(".carousel-item", e.parentNode) : []), this._items.indexOf(e);
        }
        _getItemByOrder(e, t) {
          const i = e === _t,
            s = e === kt,
          ...
          if (((s && 0 === n) || (i && n === o)) && !this._config.wrap) return t;
          const r = (n + (s ? -1 : 1)) % this._items.length;
          return -1 === r ? this._items[this._items.length - 1] : this._items[r];
        }
        _triggerSlideEvent(e, t) {
          const i = this._getItemIndex(e),
            s = this._getItemIndex(bt.findOne(".active.carousel-item", this._element));
          return ut.trigger(this._element, "slide.bs.carousel", { relatedTarget: e, direction: t, from: s, to: i });
        }
        ...
        _updateInterval() {
          const e = this._activeElement || bt.findOne(".active.carousel-item", this._element);
          if (!e) return;
            ...
            if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(o), (this._activeElement = o), this._element.classList.contains("slide"))) {
              ...
              ut.one(s, "transitionend", () => {
                o.classList.remove(c, u),
                  ...
                  (this._isSliding = !1),
                  setTimeout(() => {
                    ut.trigger(this._element, "slid.bs.carousel", { relatedTarget: o, direction: h, from: n, to: r });
                  }, 0);
              }),
                Be(s, e);
            } else
        ...
        _directionToOrder(e) {
          return [Et, Tt].includes(e) ? (Ke() ? (e === Et ? kt : _t) : e === Et ? _t : kt) : e;
        }
        _orderToDirection(e) {
          return [_t, kt].includes(e) ? (Ke() ? (e === _t ? Tt : Et) : e === _t ? Et : Tt) : e;
        }
        ...
        static dataApiClickHandler(e) {
          ...
          const i = { ...gt.getDataAttributes(t), ...gt.getDataAttributes(this) },
            s = this.getAttribute("data-bs-slide-to");
          s && (i.interval = !1), St.carouselInterface(t, i), s && Qe.get(t, "bs.carousel").to(s), e.preventDefault();
        }
      }
      ut.on(document, At, "[data-bs-slide], [data-bs-slide-to]", St.dataApiClickHandler),
        ut.on(window, Ct, () => {
          const e = bt.find('[data-bs-ride="carousel"]');
          for (let t = 0, i = e.length; t < i; t++) St.carouselInterface(e[t], Qe.get(e[t], "bs.carousel"));
        }),
        Ye("carousel", St);
      ...
      class Ot extends ht {
        constructor(e, t) {
          super(e),
            ...
            (this._config = this._getConfig(t)),
            (this._triggerArray = bt.find(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`));
        ...
        show() {
          ...
          this._parent &&
            ((e = bt
              ...
              .filter((e) => ("string" == typeof this._config.parent ? e.getAttribute("data-bs-parent") === this._config.parent : e.classList.contains("collapse")))),
            0 === e.length && (e = null));
          const i = bt.findOne(this._selector);
          if (e) {
            const s = e.find((e) => i !== e);
            if (((t = s ? Qe.get(s, "bs.collapse") : null), t && t._isTransitioning)) return;
          }
          if (ut.trigger(this._element, "show.bs.collapse").defaultPrevented) return;
          e &&
            e.forEach((e) => {
              i !== e && Ot.collapseInterface(e, "hide"), t || Qe.set(e, "bs.collapse", null);
            });
        ...
        hide() {
          ...
          ut.one(this._element, "transitionend", () => {
            this.setTransitioning(!1), this._element.classList.remove("collapsing"), this._element.classList.add("collapse"), ut.trigger(this._element, "hidden.bs.collapse");
          }),
            Be(this._element, i);
        }
        setTransitioning(e) {
        ...
        _getConfig(e) {
          return ((e = { ...xt, ...e }).toggle = Boolean(e.toggle)), qe("collapse", e, Lt), e;
        }
        _getDimension() {
        ...
        _getParent() {
          ...
          Re(e) ? (void 0 === e.jquery && void 0 === e[0]) || (e = e[0]) : (e = bt.findOne(e));
        ...
        static collapseInterface(e, t) {
          ...
          const s = { ...xt, ...gt.getDataAttributes(e), ...("object" == typeof t && t ? t : {}) };
          if ((!i && s.toggle && "string" == typeof t && /show|hide/.test(t) && (s.toggle = !1), i || (i = new Ot(e, s)), "string" == typeof t)) {
      ...
      ut.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function (e) {
        ...
        bt.find(i).forEach((e) => {
          ...
          let s;
          i ? (null === i._parent && "string" == typeof t.parent && ((i._config.parent = t.parent), (i._parent = i._getParent())), (s = "toggle")) : (s = t),
      ...
      const Pt = new RegExp("ArrowUp|ArrowDown|Escape"),
        ...
        Bt = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)" };
      class qt extends ht {
        constructor(e, t) {
          super(e),
            (this._popper = null),
        ...
        show() {
          ...
          if (!ut.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
            if (this._inNavbar) gt.setDataAttribute(this._menu, "popper", "none");
            else {
              ...
              (this._popper = Oe(t, this._menu, i)), n && gt.setDataAttribute(this._menu, "popper", "static");
            }
            "ontouchstart" in document.documentElement &&
              !e.closest(".navbar-nav") &&
              [].concat(...document.body.children).forEach((e) => ut.on(e, "mouseover", null, function () {})),
              this._element.focus(),
        ...
        dispose() {
          ut.off(this._element, ".bs.dropdown"), (this._menu = null), this._popper && (this._popper.destroy(), (this._popper = null)), super.dispose();
        }
        update() {
        ...
        _getConfig(e) {
          if (
            ((e = { ...this.constructor.Default, ...gt.getDataAttributes(this._element), ...e }),
        ...
        static dropdownInterface(e, t) {
          ...
          if ((i || (i = new qt(e, "object" == typeof t ? t : null)), "string" == typeof t)) {
            if (void 0 === i[t]) throw new TypeError(`No method named "${t}"`);
            i[t]();
          }
        }
        ...
        static clearMenus(e) {
          ...
          for (let i = 0, s = t.length; i < s; i++) {
            ...
            if (e) {
              if ([s._element].some((t) => e.composedPath().includes(t))) continue;
              if ("keyup" === e.type && "Tab" === e.key && o.contains(e.target)) continue;
            }
            ut.trigger(t[i], "hide.bs.dropdown", n).defaultPrevented ||
              ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e) => ut.off(e, "mouseover", null, function () {})),
        ...
        static dataApiKeydownHandler(e) {
          ...
          if ("Escape" === e.key) {
            return (this.matches('[data-bs-toggle="dropdown"]') ? this : bt.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void qt.clearMenus();
          }
          if (!i && ("ArrowUp" === e.key || "ArrowDown" === e.key)) {
            return void (this.matches('[data-bs-toggle="dropdown"]') ? this : bt.prev(this, '[data-bs-toggle="dropdown"]')[0]).click();
          }
          if (!i || "Space" === e.key) return void qt.clearMenus();
          const s = bt.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(Fe);
          if (!s.length) return;
          let n = s.indexOf(e.target);
          "ArrowUp" === e.key && n > 0 && n--, "ArrowDown" === e.key && n < s.length - 1 && n++, (n = -1 === n ? 0 : n), s[n].focus();
        }
      }
      ut.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', qt.dataApiKeydownHandler),
        ut.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", qt.dataApiKeydownHandler),
        ut.on(document, "click.bs.dropdown.data-api", qt.clearMenus),
        ut.on(document, "keyup.bs.dropdown.data-api", qt.clearMenus),
        ut.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', function (e) {
          e.preventDefault(), qt.dropdownInterface(this);
        }),
        Ye("dropdown", qt);
      const Ft = { backdrop: !0, keyboard: !0, focus: !0 },
        $t = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean" };
      class Wt extends ht {
        constructor(e, t) {
          super(e),
            (this._config = this._getConfig(t)),
        ...
        show(e) {
          ...
          const t = ut.trigger(this._element, "show.bs.modal", { relatedTarget: e });
          this._isShown ||
            t.defaultPrevented ||
            ((this._isShown = !0),
            ...
            ut.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (e) => this.hide(e)),
        ...
        hide(e) {
          ...
          if (
            ...
            ut.one(this._element, "transitionend", (e) => this._hideModal(e)), Be(this._element, e);
          } else this._hideModal();
        }
        dispose() {
          [window, this._element, this._dialog].forEach((e) => ut.off(e, ".bs.modal")),
            super.dispose(),
            ut.off(document, "focusin.bs.modal"),
            (this._config = null),
            (this._dialog = null),
        ...
        _showElement(e) {
          ...
          const s = () => {
            this._config.focus && this._element.focus(), (this._isTransitioning = !1), ut.trigger(this._element, "shown.bs.modal", { relatedTarget: e });
          };
          if (t) {
        ...
        _hideModal() {
          (this._element.style.display = "none"),
            ...
            (this._isTransitioning = !1),
            this._showBackdrop(() => {
              document.body.classList.remove("modal-open"), this._resetAdjustments(), this._resetScrollbar(), ut.trigger(this._element, "hidden.bs.modal");
            });
        }
        _removeBackdrop() {
        ...
        _adjustDialog() {
          const e = this._element.scrollHeight > document.documentElement.clientHeight;
          ((!this._isBodyOverflowing && e && !Ke()) || (this._isBodyOverflowing && !e && Ke())) && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
            ((this._isBodyOverflowing && !e && !Ke()) || (!this._isBodyOverflowing && e && Ke())) && (this._element.style.paddingRight = this._scrollbarWidth + "px");
        }
        _resetAdjustments() {
        ...
        _setScrollbar() {
          this._isBodyOverflowing &&
            (this._setElementAttributes(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", "paddingRight", (e) => e + this._scrollbarWidth),
            this._setElementAttributes(".sticky-top", "marginRight", (e) => e - this._scrollbarWidth),
            this._setElementAttributes("body", "paddingRight", (e) => e + this._scrollbarWidth)),
        ...
        _setElementAttributes(e, t, i) {
          bt.find(e).forEach((e) => {
            ...
            gt.setDataAttribute(e, t, s), (e.style[t] = i(Number.parseFloat(n)) + "px");
          });
        }
        _resetScrollbar() {
        ...
        _resetElementAttributes(e, t) {
          bt.find(e).forEach((e) => {
            ...
            void 0 === i && e === document.body ? (e.style[t] = "") : (gt.removeDataAttribute(e, t), (e.style[t] = i));
          });
        }
        _getScrollbarWidth() {
        ...
        static jQueryInterface(e, t) {
          return this.each(function () {
            ...
            const s = { ...Ft, ...gt.getDataAttributes(this), ...("object" == typeof e && e ? e : {}) };
      ...
      ut.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function (e) {
        ...
        if (!i) {
          const e = { ...gt.getDataAttributes(t), ...gt.getDataAttributes(this) };
          i = new Wt(t, e);
        }
        i.toggle(this);
      }),
      ...
      const zt = () => {
        ...
        Vt = (e, t, i) => {
          ...
          bt.find(e).forEach((e) => {
            ...
            gt.setDataAttribute(e, t, n), (e.style[t] = i(Number.parseFloat(o)) + "px");
          });
        },
        Ut = (e, t) => {
          bt.find(e).forEach((e) => {
            const i = gt.getDataAttribute(e, t);
            void 0 === i && e === document.body ? e.style.removeProperty(t) : (gt.removeDataAttribute(e, t), (e.style[t] = i));
          });
        },
        Kt = ".bs.offcanvas",
        Yt = `load${Kt}.data-api`,
      ...
      class Gt extends ht {
        ...
        show(e) {
          ...
          if (ut.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e }).defaultPrevented) return;
          (this._isShown = !0),
            ...
            this._config.scroll ||
              ((e = zt()) => {
                (document.body.style.overflow = "hidden"),
                  Vt(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight", (t) => t + e),
            ...
            this._element.classList.add("show");
          setTimeout(() => {
            this._element.classList.remove("offcanvas-toggling"), ut.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: e }), this._enforceFocusOnElement(this._element);
          }, je(this._element));
        }
        hide() {
          if (!this._isShown) return;
          ...
          setTimeout(() => {
            this._element.setAttribute("aria-hidden", !0),
              ...
              this._config.scroll ||
                ((document.body.style.overflow = "auto"), Ut(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight"), Ut(".sticky-top", "marginRight"), Ut("body", "paddingRight")),
              ut.trigger(this._element, "hidden.bs.offcanvas"),
              this._element.classList.remove("offcanvas-toggling");
          }, je(this._element));
        }
        _getConfig(e) {
          return (e = { ...Xt, ...gt.getDataAttributes(this._element), ...("object" == typeof e ? e : {}) }), qe("offcanvas", e, Qt), e;
        }
        ...
        _addEventListeners() {
          ut.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', () => this.hide()),
        ...
        static jQueryInterface(e) {
          return this.each(function () {
            const t = Qe.get(this, "bs.offcanvas") || new Gt(this, "object" == typeof e ? e : {});
            if ("string" == typeof e) {
      ...
      ut.on(document, Jt, '[data-bs-toggle="offcanvas"]', function (e) {
        ...
        ut.on(window, Yt, () => {
          bt.find(".offcanvas.show").forEach((e) => (Qe.get(e, "bs.offcanvas") || new Gt(e)).show());
        }),
        Ye("offcanvas", Gt);
      const Zt = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        ii = (e, t) => {
          ...
          if (t.includes(i)) return !Zt.has(i) || Boolean(ei.test(e.nodeValue) || ti.test(e.nodeValue));
      ...
      const oi = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        li = { AUTO: "auto", TOP: "top", RIGHT: Ke() ? "left" : "right", BOTTOM: "bottom", LEFT: Ke() ? "right" : "left" },
        ci = {
          animation: !0,
      ...
      class hi extends ht {
        ...
        dispose() {
          clearTimeout(this._timeout),
            ...
            ut.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
        ...
        show() {
          ...
          s.setAttribute("id", n), this._element.setAttribute("aria-describedby", n), this.setContent(), this.config.animation && s.classList.add("fade");
          const o = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this._element) : this.config.placement,
            r = this._getAttachment(o);
          this._addAttachmentClass(r);
          const a = this._getContainer();
          Qe.set(s, this.constructor.DATA_KEY, this),
            this._element.ownerDocument.documentElement.contains(this.tip) || (a.appendChild(s), ut.trigger(this._element, this.constructor.Event.INSERTED)),
            this._popper ? this._popper.update() : (this._popper = Oe(this._element, s, this._getPopperConfig(r))),
        ...
        hide() {
          ...
          if (!ut.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
            if (
              (e.classList.remove("show"),
              "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e) => ut.off(e, "mouseover", ze)),
        ...
        setContent() {
          const e = this.getTipElement();
          this.setElementContent(bt.findOne(".tooltip-inner", e), this.getTitle()), e.classList.remove("fade", "show");
        }
        setElementContent(e, t) {
          if (null !== e)
            return "object" == typeof t && Re(t)
              ...
              : void (this.config.html ? (this.config.sanitize && (t = ni(t, this.config.allowList, this.config.sanitizeFn)), (e.innerHTML = t)) : (e.textContent = t));
        }
        getTitle() {
        ...
        _initializeOnDelegatedTarget(e, t) {
          ...
          return (t = t || Qe.get(e.delegateTarget, i)) || ((t = new this.constructor(e.delegateTarget, this._getDelegateConfig())), Qe.set(e.delegateTarget, i, t)), t;
        }
        _getOffset() {
        ...
        _getContainer() {
          return !1 === this.config.container ? document.body : Re(this.config.container) ? this.config.container : bt.findOne(this.config.container);
        }
        _getAttachment(e) {
        ...
        _setListeners() {
          this.config.trigger.split(" ").forEach((e) => {
            if ("click" === e) ut.on(this._element, this.constructor.Event.CLICK, this.config.selector, (e) => this.toggle(e));
            else if ("manual" !== e) {
              ...
              ut.on(this._element, t, this.config.selector, (e) => this._enter(e)), ut.on(this._element, i, this.config.selector, (e) => this._leave(e));
            }
          }),
            (this._hideModalHandler = () => {
              this._element && this.hide();
            }),
            ut.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
        ...
        _getConfig(e) {
          ...
          return (
            ...
            "number" == typeof (e = { ...this.constructor.Default, ...t, ...("object" == typeof e && e ? e : {}) }).delay && (e.delay = { show: e.delay, hide: e.delay }),
            "number" == typeof e.title && (e.title = e.title.toString()),
            "number" == typeof e.content && (e.content = e.content.toString()),
            qe("tooltip", e, this.constructor.DefaultType),
            e.sanitize && (e.template = ni(e.template, e.allowList, e.sanitizeFn)),
            e
          );
        }
        _getDelegateConfig() {
        ...
        static jQueryInterface(e) {
          return this.each(function () {
            ...
            if ((t || !/dispose|hide/.test(e)) && (t || (t = new hi(this, i)), "string" == typeof e)) {
      ...
      class gi extends hi {
        ...
        setContent() {
          const e = this.getTipElement();
          this.setElementContent(bt.findOne(".popover-header", e), this.getTitle());
          let t = this._getContent();
          "function" == typeof t && (t = t.call(this._element)), this.setElementContent(bt.findOne(".popover-body", e), t), e.classList.remove("fade", "show");
        }
        _addAttachmentClass(e) {
        ...
        static jQueryInterface(e) {
          return this.each(function () {
            ...
            if ((t || !/dispose|hide/.test(e)) && (t || ((t = new gi(this, i)), Qe.set(this, "bs.popover", t)), "string" == typeof e)) {
              if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
              t[e]();
            }
          });
      ...
      class vi extends ht {
        constructor(e, t) {
          super(e),
            ...
            ut.on(this._scrollElement, "scroll.bs.scrollspy", () => this._process()),
            this.refresh(),
            this._process();
        }
        static get Default() {
        ...
        _getConfig(e) {
          if ("string" != typeof (e = { ...bi, ...("object" == typeof e && e ? e : {}) }).target && Re(e.target)) {
            let { id: t } = e.target;
            t || ((t = Ne("scrollspy")), (e.target.id = t)), (e.target = "#" + t);
          }
        ...
        _activate(e) {
          ...
          i.classList.contains("dropdown-item")
            ? (bt.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"), i.classList.add("active"))
            : (i.classList.add("active"),
              bt.parents(i, ".nav, .list-group").forEach((e) => {
                bt.prev(e, ".nav-link, .list-group-item").forEach((e) => e.classList.add("active")),
                  bt.prev(e, ".nav-item").forEach((e) => {
                    bt.children(e, ".nav-link").forEach((e) => e.classList.add("active"));
                  });
              })),
            ut.trigger(this._scrollElement, "activate.bs.scrollspy", { relatedTarget: e });
        }
        _clear() {
          bt.find(this._selector)
        ...
        static jQueryInterface(e) {
          return this.each(function () {
            ...
            if ((t || (t = new vi(this, "object" == typeof e && e)), "string" == typeof e)) {
              if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
              t[e]();
            }
          });
      ...
      ut.on(window, "load.bs.scrollspy.data-api", () => {
        bt.find('[data-bs-spy="scroll"]').forEach((e) => new vi(e, gt.getDataAttributes(e)));
      }),
        Ye("scrollspy", vi);
      class wi extends ht {
        static get DATA_KEY() {
        ...
        show() {
          if ((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active")) || $e(this._element)) return;
          let e;
          ...
          const s = e ? ut.trigger(e, "hide.bs.tab", { relatedTarget: this._element }) : null;
          if (ut.trigger(this._element, "show.bs.tab", { relatedTarget: e }).defaultPrevented || (null !== s && s.defaultPrevented)) return;
          this._activate(this._element, i);
          const n = () => {
            ut.trigger(e, "hidden.bs.tab", { relatedTarget: this._element }), ut.trigger(this._element, "shown.bs.tab", { relatedTarget: e });
          };
          t ? this._activate(t, t.parentNode, n) : n();
        }
        _activate(e, t, i) {
          const s = (!t || ("UL" !== t.nodeName && "OL" !== t.nodeName) ? bt.children(t, ".active") : bt.find(":scope > li > .active", t))[0],
        ...
        _transitionComplete(e, t, i) {
          if (t) {
            ...
            const e = bt.findOne(":scope > .dropdown-menu .active", t.parentNode);
          ...
          if (
            ...
            e.closest(".dropdown") && bt.find(".dropdown-toggle").forEach((e) => e.classList.add("active")), e.setAttribute("aria-expanded", !0);
          }
          i && i();
        }
        static jQueryInterface(e) {
      ...
      class Ti extends ht {
        ...
        show() {
          ...
          if ((this._element.classList.remove("hide"), Ve(this._element), this._element.classList.add("showing"), this._config.animation)) {
        ...
        hide() {
          ...
          const e = () => {
            this._element.classList.add("hide"), ut.trigger(this._element, "hidden.bs.toast");
          };
        ...
        _getConfig(e) {
          return (e = { ...ki, ...gt.getDataAttributes(this._element), ...("object" == typeof e && e ? e : {}) }), qe("toast", e, this.constructor.DefaultType), e;
        }
        _setListeners() {
          ut.on(this._element, "click.dismiss.bs.toast", '[data-bs-dismiss="toast"]', () => this.hide());
        }
        _clearTimeout() {
        ...
        static jQueryInterface(e) {
          return this.each(function () {
            ...
            if ((t || (t = new Ti(this, "object" == typeof e && e)), "string" == typeof e)) {
              if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
              t[e](this);
            }
          });
        ...
        "object" == typeof navigator &&
          (e.exports = (function () {
              ...
              v = (function () {
                function e(t, i) {
                  (function (e, t) {
                    ...
                    g(this.element) && y(this.element.rangeTouch) && ((this.config = o({}, r, {}, i)), this.init());
                }
                return (
                  (function (e, t, s) {
            ...
            const w = (e) => (null != e ? e.constructor : null),
              ...
              A = (e) => Array.isArray(e),
              S = (e) => _(e, NodeList),
              x = (e) => k(e) || ((E(e) || A(e) || S(e)) && !e.length) || (T(e) && !Object.keys(e).length);
            var L = k,
              O = T,
            ...
            function K(e = {}, ...t) {
              ...
              return O(i)
                ? (Object.keys(i).forEach((t) => {
                    O(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, { [t]: {} }), K(e[t], i[t])) : Object.assign(e, { [t]: i[t] });
                  }),
                  K(e, ...t))
                : e;
            }
            ...
            function G(e) {
              j(e) || I(e) ? Array.from(e).forEach(G) : H(e) && H(e.parentNode) && e.parentNode.removeChild(e);
            }
            function Z(e) {
              if (!H(e)) return;
            ...
            function te(e, t) {
              ...
              return (
                e.split(",").forEach((e) => {
                  ...
                  switch (t.charAt(0)) {
                    case ".":
                      N(s.class) ? (i.class = `${s.class} ${n}`) : (i.class = n);
                      break;
                    case "#":
                      i.id = t.replace("#", "");
                      break;
            ...
            function le(e = null, t = !1) {
              H(e) && (e.focus({ preventScroll: !0 }), t && se(e, this.config.classNames.tabFocus));
            }
              ...
              ue = {
                ...
                check(e, t, i) {
                  const s = V.isIPhone && i && ue.playsinline,
                    n = ue[e] || "html5" !== t;
                  return { api: n, ui: n && ue.rangeInput && ("video" !== e || !V.isIPhone || s) };
                },
                pip: !(V.isIPhone || (!M(Q("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || Q("video").disablePictureInPicture))),
            ...
            function de(e, t, i, s = !1, n = !0, o = !1) {
              ...
              he && (a = { passive: n, capture: o }),
                r.forEach((t) => {
                  this && this.eventListeners && s && this.eventListeners.push({ element: e, type: t, callback: i, options: a }),
            ...
            function Te(e) {
              return !!(I(e) || (N(e) && e.includes(":"))) && (I(e) ? e : e.split(":")).map(Number).every(P);
            }
            function Ee(e) {
            ...
            function Ce(e) {
              ...
              let i = t(e);
              if ((null === i && (i = t(this.config.ratio)), null === i && !$(this.embed) && I(this.embed.ratio) && ({ ratio: i } = this.embed), null === i && this.isHTML5)) {
            ...
            function Ae(e) {
              ...
              const [s, n] = i,
                o = (100 / s) * n;
              if (
                (window.CSS && window.CSS.supports(`aspect-ratio: ${s}/${n}`) ? (t.style.aspectRatio = `${s}/${n}`) : (t.style.paddingBottom = o + "%"),
            ...
            const xe = {
              ...
              setup() {
                ...
                (e.options.speed = e.config.speed.options),
                  ...
                  Object.defineProperty(e.media, "quality", {
                    ...
                    set(t) {
                      if (e.quality !== t) {
                        if (e.config.quality.forced && M(e.config.quality.onChange)) e.config.quality.onChange(t);
                        else {
                          const i = xe.getSources.call(e).find((e) => Number(e.getAttribute("size")) === t);
                          if (!i) return;
                          const { currentTime: s, paused: n, preload: o, readyState: r, playbackRate: a } = e.media;
                          (e.media.src = i.getAttribute("src")),
                            ("none" !== o || r) &&
                              (e.once("loadedmetadata", () => {
                                (e.speed = a), (e.currentTime = s), n || ve(e.play());
                              }),
                              e.media.load());
                        }
              ...
              cancelRequests() {
                this.isHTML5 &&
                  (G(xe.getSources.call(this)), this.media.setAttribute("src", this.config.blankVideo), this.media.load(), this.debug.log("Cancelled network requests"));
              },
            };
            function Le(e, ...t) {
              return $(e) ? e : e.toString().replace(/{(\d+)}/g, (e, i) => t[i].toString());
            }
            const Oe = (e = "", t = "", i = "") => e.replace(new RegExp(t.toString().replace(/([.*+?^=!:${}()|[\]/\\])/g, "\\$1"), "g"), i.toString()),
              Pe = (e = "") => e.toString().replace(/\w\S*/g, (e) => e.charAt(0).toUpperCase() + e.substr(1).toLowerCase());
            function Ne(e) {
              ...
              constructor(t) {
                e(this, "get", (e) => {
                  ...
                  e(this, "set", (e) => {
                    ...
                    if (!O(e)) return;
                    let t = this.get();
                    $(t) && (t = {}), K(t, e), window.localStorage.setItem(this.key, JSON.stringify(t));
                  }),
            ...
            function He(e, t) {
              ...
              if (!i || !n()) {
                ...
                je(e)
                  .then((e) => {
                    $(e) || (n && window.localStorage.setItem("cache-" + t, JSON.stringify({ content: e })), o(r, e));
                  })
                  .catch(() => {});
              }
            }
            ...
            function Be(e = 0, t = !1, i = !1) {
              ...
              return (n = t || n > 0 ? n + ":" : ""), `${i && e > 0 ? "-" : ""}${n}${s(o)}:${s(a)}`;
            }
            const qe = {
              getIconUrl() {
              ...
              createIcon(e, t) {
                ...
                const r = document.createElementNS(i, "use"),
                  a = `${n}-${e}`;
                return (
                  "href" in r && r.setAttributeNS("http://www.w3.org/1999/xlink", "href", a), r.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a), o.appendChild(r), o
                );
              },
              createLabel(e, t = {}) {
                const i = Me.get(e, this.config);
                return Q("span", { ...t, class: [t.class, this.config.classNames.hidden].filter(Boolean).join(" ") }, i);
              },
              createBadge(e) {
                if ($(e)) return null;
              ...
              createButton(e, t) {
                ...
                let s = (function (e = "") {
                  ...
                  return (
                    (t = (function (e = "") {
                      let t = e.toString();
                      return (t = Oe(t, "-", " ")), (t = Oe(t, "_", " ")), (t = Pe(t)), Oe(t, " ", "");
                    })(t)),
                ...
                switch (
                  ...
                  Object.keys(i).includes("class")
                    ? i.class.split(" ").some((e) => e === this.config.classNames.control) || K(i, { class: `${i.class} ${this.config.classNames.control}` })
                ...
                return (
                  n.toggle
                    ? (o.appendChild(qe.createIcon.call(this, n.iconPressed, { class: "icon--pressed" })),
                      o.appendChild(qe.createIcon.call(this, n.icon, { class: "icon--not-pressed" })),
                      o.appendChild(qe.createLabel.call(this, n.labelPressed, { class: "label--pressed" })),
                      o.appendChild(qe.createLabel.call(this, n.label, { class: "label--not-pressed" })))
                    : (o.appendChild(qe.createIcon.call(this, n.icon)), o.appendChild(qe.createLabel.call(this, n.label))),
                  K(i, te(this.config.selectors.buttons[s], i)),
                  X(o, i),
                  "play" === s ? (I(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(o)) : (this.elements.buttons[s] = o),
                  o
                );
              },
              createRange(e, t) {
                ...
                return (this.elements.inputs[e] = i), qe.updateRangeFill.call(this, i), v.setup(i), i;
              },
              createProgress(e, t) {
                const i = Q("progress", K(te(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: "progressbar", "aria-hidden": !0 }, t));
                if ("volume" !== e) {
              ...
              createTime(e, t) {
                const i = te(this.config.selectors.display[e], t),
                  s = Q("div", K(i, { class: `${i.class ? i.class : ""} ${this.config.classNames.display.time} `.trim(), "aria-label": Me.get(e, this.config) }), "00:00");
              ...
              bindMenuItemShortcuts(e, t) {
                pe.call(
                  ...
                  (i) => {
                    ...
                    if (!s && [32, 39].includes(i.which)) qe.showMenuPanel.call(this, t, !0);
                    else {
                      let t;
                      32 !== i.which &&
                  ...
                  pe.call(this, e, "keyup", (e) => {
                    13 === e.which && qe.focusFirstMenuItem.call(this, null, !0);
                  });
              },
              createMenuItem({ value: e, list: t, type: i, title: s, badge: n = null, checked: o = !1 }) {
                const r = te(this.config.selectors.inputs[i]),
                  a = Q(
                    "button",
                    K(r, { type: "button", role: "menuitemradio", class: `${this.config.classNames.control} ${r.class ? r.class : ""}`.trim(), "aria-checked": o, value: e })
                  ),
                  l = Q("span");
                (l.innerHTML = s),
                  H(n) && l.appendChild(n),
              ...
              updateVolume() {
                this.supported.ui &&
                  (H(this.elements.inputs.volume) && qe.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
              ...
              updateSeekTooltip(e) {
                ...
                s < 0 ? (s = 0) : s > 100 && (s = 100),
                  qe.updateTimeDisplay.call(this, this.elements.display.seekTooltip, (this.duration / 100) * s),
                  (this.elements.display.seekTooltip.style.left = s + "%"),
                  R(e) && ["mouseenter", "mouseleave"].includes(e.type) && i("mouseenter" === e.type);
              },
              timeUpdate(e) {
              ...
              updateSetting(e, t, i) {
                ...
                if ("captions" === e) n = this.currentTrack;
                  ...
                  if (((n = $(i) ? this[e] : i), $(n) && (n = this.config[e].default), !$(this.options[e]) && !this.options[e].includes(n)))
                    return void this.debug.warn(`Unsupported value of '${n}' for ${e}`);
                  if (!this.config[e].options.includes(n)) return void this.debug.warn(`Disabled value of '${n}' for ${e}`);
                }
                if ((H(o) || (o = s && s.querySelector('[role="menu"]')), !H(o))) return;
              ...
              getLabel(e, t) {
                switch (e) {
                  case "speed":
                    return 1 === t ? Me.get("normal", this.config) : t + "&times;";
                  case "quality":
                    if (P(t)) {
              ...
              setQualityMenu(e) {
                ...
                if ((qe.toggleMenuButton.call(this, t, s), Z(i), qe.checkMenu.call(this), !s)) return;
                const n = (e) => {
                ...
                this.options.quality
                  ...
                  .forEach((e) => {
                    qe.createMenuItem.call(this, { value: e, list: i, type: t, title: qe.getLabel.call(this, "quality", e), badge: n(e) });
                  }),
              ...
              setCaptionsMenu() {
                ...
                const e = "captions",
                  ...
                  s = Boolean(i.length);
                if ((qe.toggleMenuButton.call(this, e, s), Z(t), qe.checkMenu.call(this), !s)) return;
                const n = i.map((e, i) => ({
                  value: i,
                ...
                n.unshift({ value: -1, checked: !this.captions.toggled, title: Me.get("disabled", this.config), list: t, type: "language" }),
                ...
                qe.toggleMenuButton.call(this, e, i),
                  ...
                  i &&
                    (this.options.speed.forEach((i) => {
                      qe.createMenuItem.call(this, { value: i, list: t, type: e, title: qe.getLabel.call(this, "speed", i) });
                    }),
                    qe.updateSetting.call(this, e, t));
              },
              checkMenu() {
              ...
              toggleMenu(e) {
                ...
                i.setAttribute("aria-expanded", n),
                  ie(t, !n),
                  se(this.elements.container, this.config.classNames.menu.open, n),
                  n && B(e) ? qe.focusFirstMenuItem.call(this, null, !0) : n || s || le.call(this, i, B(e));
              },
              getMenuSize(e) {
              ...
              showMenuPanel(e = "", t = !1) {
                ...
                if (ue.transitions && !ue.reducedMotion) {
                  ...
                  const e = qe.getMenuSize.call(this, i),
                    t = (e) => {
                      e.target === s && ["width", "height"].includes(e.propertyName) && ((s.style.width = ""), (s.style.height = ""), me.call(this, s, W, t));
                    };
                  pe.call(this, s, W, t), (s.style.width = e.width + "px"), (s.style.height = e.height + "px");
                }
              ...
              create(e) {
                const { bindMenuItemShortcuts: t, createButton: i, createProgress: s, createRange: n, createTime: o, setQualityMenu: r, setSpeedMenu: a, showMenuPanel: l } = qe;
                ...
                return (
                  we(I(this.config.controls) ? this.config.controls : []).forEach((r) => {
                    if (
                    ...
                    if (
                      ("current-time" === r && c.appendChild(o.call(this, "currentTime", u)),
                      "duration" === r && c.appendChild(o.call(this, "duration", u)),
                      "mute" === r || "volume" === r)
                    ) {
                      let { volume: t } = this.elements;
                      if (
                        ((H(t) && c.contains(t)) || ((t = Q("div", K({}, u, { class: (u.class + " plyr__volume").trim() }))), (this.elements.volume = t), c.appendChild(t)),
                    ...
                    if (("captions" === r && c.appendChild(i.call(this, "captions", u)), "settings" === r && !$(this.config.settings))) {
                      const s = Q("div", K({}, u, { class: (u.class + " plyr__menu").trim(), hidden: "" }));
                      s.appendChild(i.call(this, "settings", { "aria-haspopup": !0, "aria-controls": "plyr-settings-" + e.id, "aria-expanded": !1 }));
                      const n = Q("div", { class: "plyr__menu__container", id: "plyr-settings-" + e.id, hidden: "" }),
                        o = Q("div"),
                      ...
                      r.appendChild(a),
                        ...
                        this.config.settings.forEach((i) => {
                          ...
                          const n = Q("span", null, Me.get(i, this.config)),
                            r = Q("span", { class: this.config.classNames.menu.value });
                          (r.innerHTML = e[i]), n.appendChild(r), s.appendChild(n), a.appendChild(s);
                          const c = Q("div", { id: `plyr-settings-${e.id}-${i}`, hidden: "" }),
                            u = Q("button", { type: "button", class: `${this.config.classNames.control} ${this.config.classNames.control}--back` });
                          u.appendChild(Q("span", { "aria-hidden": !0 }, Me.get(i, this.config))),
                            u.appendChild(Q("span", { class: this.config.classNames.hidden }, Me.get("menuBack", this.config))),
                            pe.call(
                              this,
                              c,
                              "keydown",
                    ...
                    if (
                      ("pip" === r && ue.pip && c.appendChild(i.call(this, "pip", u)), "airplay" === r && ue.airplay && c.appendChild(i.call(this, "airplay", u)), "download" === r)
                    ) {
                      const e = K({}, u, { element: "a", href: this.download, target: "_blank" });
              ...
              inject() {
                ...
                let i,
                  s = !0;
                if (
                  (M(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
                  this.config.controls || (this.config.controls = []),
                  H(this.config.controls) || N(this.config.controls)
                    ? (e = this.config.controls)
                    : ((e = qe.create.call(this, { id: this.id, seektime: this.config.seekTime, speed: this.speed, quality: this.quality, captions: We.getLabel.call(this) })),
                      (s = !1)),
                  s &&
                  ...
                  N(this.config.selectors.controls.container) && (i = document.querySelector(this.config.selectors.controls.container)),
                  H(i) || (i = this.elements.container),
                  i[H(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e),
            ...
            const We = {
                setup() {
                  ...
                  if (
                    (H(this.elements.captions) ||
                      ((this.elements.captions = Q("div", te(this.config.selectors.captions))),
                  ...
                  if ((D(n) || ({ active: n } = this.config.captions), Object.assign(this.captions, { toggled: !1, active: n, language: s, languages: i }), this.isHTML5)) {
                    const e = this.config.captions.update ? "addtrack removetrack" : "removetrack";
                    pe.call(this, this.media.textTracks, e, We.update.bind(this));
                  }
                    ...
                    e
                      ...
                      .forEach((e) => {
                        this.debug.log("Track added", e),
                          ...
                          pe.call(this, e, "cuechange", () => We.updateCues.call(this));
                      }),
                    ((o && this.language !== i) || !e.includes(n)) && (We.setLanguage.call(this, i), We.toggle.call(this, t && o)),
                    se(this.elements.container, this.config.classNames.captions.enabled, !$(e)),
                    I(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && qe.setCaptionsMenu.call(this);
                },
                toggle(e, t = !0) {
                  if (!this.supported.ui) return;
                  ...
                  if (n !== i) {
                    if ((t || ((this.captions.active = n), this.storage.set({ captions: n })), !this.language && n && !t)) {
                      ...
                      return (this.captions.language = t.language), void We.set.call(this, e.indexOf(t));
                    }
                    this.elements.buttons.captions && (this.elements.buttons.captions.pressed = n),
                      ...
                      ge.call(this, this.media, n ? "captionsenabled" : "captionsdisabled");
                  }
                  setTimeout(() => {
                ...
                findTrack(e, t = !1) {
                  ...
                  let o;
                  return e.every((e) => ((o = n.find((t) => t.language === e)), !o)), o || (t ? n[0] : void 0);
                },
                getCurrentTrack() {
                ...
                getLabel(e) {
                  let t = e;
                  return (
                    !q(t) && ue.textTracks && this.captions.toggled && (t = We.getCurrentTrack.call(this)),
                    q(t) ? ($(t.label) ? ($(t.language) ? Me.get("enabled", this.config) : e.language.toUpperCase()) : t.label) : Me.get("disabled", this.config)
                  );
                },
                updateCues(e) {
                  if (!this.supported.ui) return;
                  ...
                  if (i !== this.elements.captions.innerHTML) {
                    ...
                    (e.innerHTML = i), this.elements.captions.appendChild(e), ge.call(this, this.media, "cuechange");
                  }
                },
              },
              ze = {
            ...
            class Xe {
              constructor(t) {
                e(this, "onChange", () => {
                  ...
                  e(this, "trapFocus", (e) => {
                    if (V.isIos || !this.active || "Tab" !== e.key || 9 !== e.keyCode) return;
                    const t = document.activeElement,
                      i = re.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"),
                      [s] = i,
                      n = i[i.length - 1];
                  ...
                  e(this, "update", () => {
                    if (this.enabled) {
                      let e;
                      (e = this.forceFallback ? "Fallback (forced)" : Xe.native ? "Native" : "Fallback"), this.player.debug.log(e + " fullscreen enabled");
                  ...
                  e(this, "enter", () => {
                    this.enabled &&
                      (V.isIos && this.player.config.fullscreen.iosNative
                        ...
                        : this.prefix
                        ? $(this.prefix) || this.target[`${this.prefix}Request${this.property}`]()
                        : this.target.requestFullscreen({ navigationUI: "hide" }));
                  }),
                  e(this, "exit", () => {
                    if (this.enabled)
                      if (V.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), ve(this.player.play());
                      else if (!Xe.native || this.forceFallback) this.toggleFallback(!1);
                      else if (this.prefix) {
                        if (!$(this.prefix)) {
              ...
              static get prefix() {
                ...
                let e = "";
                return ["webkit", "moz", "ms"].some((t) => !((!M(document[t + "ExitFullscreen"]) && !M(document[t + "CancelFullScreen"])) || ((e = t), 0))), e;
              }
              static get property() {
              ...
              get active() {
                ...
                if (!Xe.native || this.forceFallback) return ne(this.target, this.player.config.classNames.fullscreen.fallback);
            ...
            const Je = {
              ...
              build() {
                if ((this.listeners.media(), !this.supported.ui))
                  return this.debug.warn(`Basic support only for ${this.provider} ${this.type}`), void Je.toggleNativeControls.call(this, !0);
                H(this.elements.controls) || (qe.inject.call(this), this.listeners.controls()),
                  ...
                  se(this.elements.container, this.config.classNames.isIos, V.isIos),
                  ...
                  this.poster && Je.setPoster.call(this, this.poster, !1).catch(() => {}),
                  this.config.duration && qe.durationUpdate.call(this);
              },
              setTitle() {
                let e = Me.get("play", this.config);
                if (
                  (N(this.config.title) && !$(this.config.title) && (e += ", " + this.config.title),
                ...
                return t && this.poster
                  ...
                  : (this.media.setAttribute("data-poster", e),
                    ...
                    ye
                      ...
                      .then(() => (Object.assign(this.elements.poster.style, { backgroundImage: `url('${e}')`, backgroundSize: "" }), Je.togglePoster.call(this, !0), e)));
              },
              checkPlaying(e) {
                se(this.elements.container, this.config.classNames.playing, this.playing),
                  ...
                  Array.from(this.elements.buttons.play || []).forEach((e) => {
                    Object.assign(e, { pressed: this.playing }), e.setAttribute("aria-label", Me.get(this.playing ? "pause" : "play", this.config));
                  }),
                  (R(e) && "timeupdate" === e.type) || Je.toggleControls.call(this);
              },
              checkLoading(e) {
                (this.loading = ["stalled", "waiting"].includes(e.type)),
                  ...
                  (this.timers.loading = setTimeout(
                    () => {
                      se(this.elements.container, this.config.classNames.loading, this.loading), Je.toggleControls.call(this);
                    },
                    this.loading ? 250 : 0
                  ));
              },
                  ...
                  e(this, "container", () => {
                    ...
                    !t.keyboard.global && t.keyboard.focused && pe.call(e, i.container, "keydown keyup", this.handleKey, !1),
                      pe.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t) => {
                        ...
                        let o = 0;
                        ["touchstart", "touchmove", "mousemove"].includes(t.type) && (Je.toggleControls.call(e, !0), (o = e.touch ? 3e3 : 2e3)),
                          clearTimeout(s.controls),
                          (s.controls = setTimeout(() => Je.toggleControls.call(e, !1), o));
                      });
                    const n = (t) => {
                    ...
                    pe.call(e, i.container, "enterfullscreen exitfullscreen", (t) => {
                      ...
                      ((t, i, s) => {
                        ...
                        const n = e.elements.wrapper.firstChild,
                          [, o] = t,
                          [r, a] = Ce.call(e);
                        (n.style.maxWidth = s ? (o / a) * r + "px" : null), (n.style.margin = s ? "0 auto" : null);
                      })(c, 0, a),
                        a && setTimeout(() => z(i.container), 100),
                        r || (a ? pe.call(e, window, "resize", o) : me.call(e, window, "resize", o));
                    });
                  }),
                  e(this, "media", () => {
                    const { player: e } = this,
                      { elements: t } = e;
                    if (
                      (pe.call(e, e.media, "timeupdate seeking seeked", (t) => qe.timeUpdate.call(e, t)),
                      pe.call(e, e.media, "durationchange loadeddata loadedmetadata", (t) => qe.durationUpdate.call(e, t)),
                      pe.call(e, e.media, "ended", () => {
                        e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause());
                      }),
                      pe.call(e, e.media, "progress playing seeking seeked", (t) => qe.updateProgress.call(e, t)),
                      pe.call(e, e.media, "volumechange", (t) => qe.updateVolume.call(e, t)),
                      pe.call(e, e.media, "playing play pause ended emptied timeupdate", (t) => Je.checkPlaying.call(e, t)),
                      pe.call(e, e.media, "waiting canplay seeked playing", (t) => Je.checkLoading.call(e, t)),
                    ...
                    e.supported.ui &&
                      ...
                      pe.call(e, e.media, "ratechange", () => {
                        qe.updateSetting.call(e, "speed"), e.storage.set({ speed: e.speed });
                      }),
                    ...
                    pe.call(e, e.media, i, (i) => {
                      let { detail: s = {} } = i;
                      "error" === i.type && (s = e.media.error), ge.call(e, t.container, i.type, !0, s);
                    });
                  }),
                  e(this, "proxy", (e, t, i) => {
                    const { player: s } = this,
                    ...
                    let o = !0;
                    M(n) && (o = n.call(s, e)), !1 !== o && M(t) && t.call(s, e);
                  }),
                  ...
                  e(this, "controls", () => {
                    ...
                    if (
                      ...
                      this.bind(
                        ...
                        "click",
                        (t) => {
                          t.stopPropagation(), t.preventDefault(), qe.toggleMenu.call(e, t);
                        },
                        null,
                        !1
                      ),
                      this.bind(
                        ...
                        (t) => {
                          const i = t.which;
                          [13, 32].includes(i) && (13 !== i ? (t.preventDefault(), t.stopPropagation(), qe.toggleMenu.call(e, t)) : qe.focusFirstMenuItem.call(e, null, !0));
                        },
                        null,
                        !1
                      ),
                      ...
                      this.bind(t.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (t) => {
                        ...
                        o && r ? (i.removeAttribute(n), ve(e.play())) : !r && e.playing && (i.setAttribute(n, ""), e.pause());
                      }),
                      V.isIos)
                    ) {
                      const t = re.call(e, 'input[type="range"]');
                      Array.from(t).forEach((e) => this.bind(e, i, (e) => z(e.target)));
                    }
                    this.bind(
                      t.inputs.seek,
                      i,
                      ...
                      V.isWebkit &&
                        Array.from(re.call(e, 'input[type="range"]')).forEach((t) => {
                          this.bind(t, "input", (t) => qe.updateRangeFill.call(e, t.target));
                        }),
                      e.config.toggleInvert &&
                        !H(t.display.duration) &&
                        this.bind(t.display.currentTime, "click", () => {
                          0 !== e.currentTime && ((e.config.invertTime = !e.config.invertTime), qe.timeUpdate.call(e));
                        }),
                      this.bind(
                        t.inputs.volume,
                        i,
                ...
                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && P(s))
                  if (n) {
                    ...
                    if (H(n)) {
                      ...
                      if (32 === e.which && oe(n, 'button, [role^="menuitem"]')) return;
                    }
                      ...
                      (n = n || 0),
                        /(^css!|\.css$)/.test(d)
                          ? (((a = l.createElement("link")).rel = "stylesheet"),
                            (a.href = p),
                            (o = "hideFocus" in a) && a.relList && ((o = 0), (a.rel = "preload"), (a.as = "style")))
                    ...
                    function l(e, i, s) {
                      ...
                      function c(t, i) {
                        a(
                          e,
                          function (e) {
                            o(l, e), t && o({ success: t, error: i }, e), n(r, e);
                          },
                          l
                        );
                      }
                        ...
                        return (
                          (function (e, t) {
                            ...
                            for (
                              ...
                              (o = e[l]), (r = i[o]) ? n(o, r) : (s[o] = s[o] || []).push(n);
                          })(e, function (e) {
                            o(t, e);
                          }),
                          l
            ...
            const it = {
              ...
              ready() {
                ...
                const o = $e({ loop: e.config.loop.active, autoplay: e.autoplay, muted: e.muted, gesture: "media", playsinline: !this.config.fullscreen.iosNative, ...n });
                let r = e.media.getAttribute("src");
                $(r) && (r = e.media.getAttribute(e.config.attributes.embed.id));
                const a = $((l = r)) ? null : P(Number(l)) ? l : l.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : l;
                var l;
                const c = Q("iframe"),
                ...
                if (
                  ...
                  c.setAttribute("data-poster", e.poster), (e.media = ee(c, e.media));
                else {
                ...
                t.customControls ||
                  je(Le(e.config.urls.vimeo.api, u)).then((t) => {
                    !$(t) && t.thumbnail_url && Je.setPoster.call(e, t.thumbnail_url).catch(() => {});
                  }),
                ...
                Object.defineProperty(e.media, "loop", {
                  ...
                  e.embed.on("timeupdate", (t) => {
                    (e.media.seeking = !1), (h = t.seconds), ge.call(e, e.media, "timeupdate");
                  }),
            ...
            const ot = {
                setup() {
                  if ((se(this.elements.wrapper, this.config.classNames.embed, !0), O(window.YT) && M(window.YT.Player))) ot.ready.call(this);
                  else {
                  ...
                  je(Le(this.config.urls.youtube.api, e))
                    .then((e) => {
                      if (O(e)) {
                        ...
                        (this.config.title = t), Je.setTitle.call(this), (this.embed.ratio = Se(s, i));
                      }
                      Ae.call(this);
                    })
                    .catch(() => {
                ...
                ready() {
                  ...
                  const n = $((o = s)) ? null : o.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : o;
                  var o;
                  const r = Q("div", { id: `${e.provider}-${Math.floor(1e4 * Math.random())}`, "data-poster": t.customControls ? e.poster : void 0 });
                    ...
                    events: {
                      onError(t) {
                        if (!e.media.error) {
                          ...
                          (e.media.error = { code: i, message: s }), ge.call(e, e.media, "error");
                        }
                      },
                      onPlaybackRateChange(t) {
                        const i = t.target;
                        (e.media.playbackRate = i.getPlaybackRate()), ge.call(e, e.media, "ratechange");
                      },
                      onReady(i) {
                        ...
                        ot.getTitle.call(e, n),
                          ...
                          Object.defineProperty(e.media, "currentTime", {
                            ...
                            set(t) {
                              e.paused && !e.embed.hasPlayed && e.embed.mute(), (e.media.seeking = !0), ge.call(e, e.media, "seeking"), s.seekTo(t);
                            },
                          }),
                          Object.defineProperty(e.media, "playbackRate", {
                        ...
                        Object.defineProperty(e.media, "volume", {
                          get: () => o,
                          set(t) {
                            (o = t), s.setVolume(100 * o), ge.call(e, e.media, "volumechange");
                          },
                        });
                        ...
                        Object.defineProperty(e.media, "muted", {
                          ...
                          set(t) {
                            const i = D(t) ? t : r;
                            (r = i), s[i ? "mute" : "unMute"](), s.setVolume(100 * o), ge.call(e, e.media, "volumechange");
                          },
                        }),
                        ...
                        (e.options.speed = a.filter((t) => e.config.speed.options.includes(t))),
                          ...
                          (e.timers.buffering = setInterval(() => {
                            (e.media.buffered = s.getVideoLoadedFraction()),
                              ...
                              1 === e.media.buffered && (clearInterval(e.timers.buffering), ge.call(e, e.media, "canplaythrough"));
                          }, 200)),
                          t.customControls && setTimeout(() => Je.build.call(e), 50);
                      },
                      onStateChange(i) {
                        const s = i.target;
                        switch ((clearInterval(e.timers.playing), e.media.seeking && [1, 2].includes(i.data) && ((e.media.seeking = !1), ge.call(e, e.media, "seeked")), i.data)) {
                          case -1:
                            ge.call(e, e.media, "timeupdate"), (e.media.buffered = s.getVideoLoadedFraction()), ge.call(e, e.media, "progress");
                            break;
                          case 0:
                            st.call(e, !1), e.media.loop ? (s.stopVideo(), s.playVideo()) : ge.call(e, e.media, "ended");
                            break;
                          case 1:
                            t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                              ...
                              : (st.call(e, !0),
                                ...
                                e.media.duration !== s.getDuration() && ((e.media.duration = s.getDuration()), ge.call(e, e.media, "durationchange")));
                            break;
                          case 2:
                        ...
                        ge.call(e, e.elements.container, "statechange", !1, { code: i.data });
                      },
                    },
                  });
                },
              ...
              rt = {
                setup() {
                  this.media
                    ? (se(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
                      ...
                      this.isHTML5 ? xe.setup.call(this) : this.isYouTube ? ot.setup.call(this) : this.isVimeo && it.setup.call(this))
            ...
            class at {
              constructor(t) {
                e(this, "load", () => {
                  ...
                  e(this, "ready", () => {
                    var e;
                    this.enabled ||
                      ((e = this).manager && e.manager.destroy(), e.elements.displayContainer && e.elements.displayContainer.destroy(), e.elements.container.remove()),
                  ...
                  e(this, "pollCountdown", (e = !1) => {
                    ...
                    this.countdownTimer = setInterval(() => {
                      const e = Be(Math.max(this.manager.getRemainingTime(), 0)),
                        t = `${Me.get("advertisement", this.player.config)} - ${e}`;
                        ...
                        if (0 !== e && -1 !== e && e < this.player.duration) {
                          ...
                          if (H(t)) {
                            const i = (100 / this.player.duration) * e,
                              s = Q("span", { class: this.player.config.classNames.cues });
                  ...
                  e(this, "on", (e, t) => (I(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)),
              ...
              get enabled() {
                const { config: e } = this;
                return this.player.isHTML5 && this.player.isVideo && e.enabled && (!$(e.publisherId) || F(e.tagUrl));
              }
              get tagUrl() {
                const { config: e } = this;
                return F(e.tagUrl)
            ...
            class ut {
                ...
                e(this, "load", () => {
                  ...
                  e(
                    ...
                    (e) =>
                      new Promise((t) => {
                        je(e).then((i) => {
                          const s = { frames: lt(i), height: null, urlPrefix: "" };
                  ...
                  e(this, "endScrubbing", () => {
                    (this.mouseDown = !1),
                      Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime)
                        ...
                        : fe.call(this.player, this.player.media, "timeupdate", () => {
                  ...
                  e(this, "render", () => {
                    (this.elements.thumb.container = Q("div", { class: this.player.config.classNames.previewThumbnails.thumbContainer })),
                      (this.elements.thumb.imageContainer = Q("div", { class: this.player.config.classNames.previewThumbnails.imageContainer })),
                    ...
                    (this.elements.thumb.time = Q("span", {}, "00:00")),
                      ...
                      (this.elements.scrubbing.container = Q("div", { class: this.player.config.classNames.previewThumbnails.scrubbingContainer })),
                  ...
                  e(this, "loadImage", (e = 0) => {
                    ...
                    if (this.currentImageElement && this.currentImageElement.dataset.filename === o)
                      this.showImage(this.currentImageElement, n, e, t, o, !1), (this.currentImageElement.dataset.index = t), this.removeOldImages(this.currentImageElement);
                    else {
                  ...
                  e(this, "showImage", (e, t, i, s, n, o = !0) => {
                    this.player.debug.log(`Showing thumb: ${n}. num: ${s}. qual: ${i}. newimg: ${o}`),
                      this.setImageSizeAndOffset(e, t),
                      o && (this.currentImageContainer.appendChild(e), (this.currentImageElement = e), this.loadedImages.includes(n) || this.loadedImages.push(n)),
                  ...
                  e(this, "setScrubbingContainerSize", () => {
                    const { width: e, height: t } = ct(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight });
              ...
              get thumbContainerHeight() {
                if (this.mouseDown) {
                  const { height: e } = ct(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight });
                  return e;
                }
                ...
                U(e, "sources.length")
                  ? (xe.cancelRequests.call(this),
                    this.destroy.call(
                      this,
                      () => {
                        (this.options.quality = []), G(this.media), (this.media = null), H(this.elements.container) && this.elements.container.removeAttribute("class");
                        const { sources: t, type: i } = e,
                          [{ provider: s = Ue.html5, src: n }] = t,
                          o = "html5" === s ? i : "div",
                          r = "html5" === s ? {} : { src: n };
                        Object.assign(this, { provider: s, type: i, supported: ue.check(i, s, this.config.playsinline), media: Q(o, r) }),
                          ...
                          (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && Je.build.call(this),
            ...
            class dt {
              constructor(t, i) {
                if (
                  (e(this, "play", () =>
                    M(this.media.play)
                      ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => ve(this.media.play())), this.media.play())
                      : null
                  ),
                  e(this, "pause", () => (this.playing && M(this.media.pause) ? this.media.pause() : null)),
                  e(this, "togglePlay", (e) => ((D(e) ? e : !this.playing) ? this.play() : this.pause())),
                  e(this, "stop", () => {
                    this.isHTML5 ? (this.pause(), this.restart()) : M(this.media.stop) && this.media.stop();
                  }),
                  e(this, "restart", () => {
                    this.currentTime = 0;
                  }),
                  ...
                  e(this, "toggleControls", (e) => {
                    if (this.supported.ui && !this.isAudio) {
                      ...
                      if ((s && I(this.config.controls) && this.config.controls.includes("settings") && !$(this.config.settings) && qe.toggleMenu.call(this, !1), s !== t)) {
                  ...
                  e(this, "destroy", (e, t = !1) => {
                    ...
                    this.stop(),
                      ...
                      this.isHTML5
                        ...
                        : this.isYouTube
                        ? (clearInterval(this.timers.buffering), clearInterval(this.timers.playing), null !== this.embed && M(this.embed.destroy) && this.embed.destroy(), i())
                  ...
                  (this.touch = ue.touch),
                  (this.media = t),
                  N(this.media) && (this.media = document.querySelectorAll(this.media)),
                    ...
                    if (((o = this.media.querySelector("iframe")), H(o))) {
                      if (
                        ...
                        e.includes(r.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                          ...
                          this.isYouTube
                            ? ((this.config.playsinline = e.includes(r.searchParams.get("playsinline"))), (this.config.youtube.hl = r.searchParams.get("hl")))
                            : (this.config.playsinline = !0);
                      }
                    } else (this.provider = this.media.getAttribute(this.config.attributes.embed.provider)), this.media.removeAttribute(this.config.attributes.embed.provider);
                    if ($(this.provider) || !Object.values(Ue).includes(this.provider)) return void this.debug.error("Setup failed: Invalid provider");
                    this.type = "video";
                    break;
                  case "video":
                  case "audio":
                ...
                (this.supported = ue.check(this.type, this.provider, this.config.playsinline)),
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      H(this.elements.container) || ((this.elements.container = Q("div", { tabindex: 0 })), Y(this.media, this.elements.container)),
              ...
              set quality(e) {
                ...
                if (!i.length) return;
                let s = [!$(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(P),
                  n = !0;
                if (!i.includes(s)) {
                  const e = _e(i, s);
              ...
              set download(e) {
                F(e) && ((this.config.urls.download = e), qe.setDownloadUrl.call(this));
              }
              set poster(e) {
              ...
              set pip(e) {
                ...
                M(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Ve : "inline"),
              ...
              get pip() {
                return ue.pip ? ($(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === Ve) : null;
              }
              ...
              static setup(e, t = {}) {
                let i = null;
                return N(e) ? (i = Array.from(document.querySelectorAll(e))) : j(e) ? (i = Array.from(e)) : I(e) && (i = e.filter(H)), $(i) ? null : i.map((e) => new dt(e, t));
              }
            }
            var pt;
            return (dt.defaults = ((pt = ze), JSON.parse(JSON.stringify(pt)))), dt;
          })());
      }).call(this, i(7));
    },
    function (e, t, i) {
        ...
        function (e, t, i) {
          ...
          var n =
            ...
            g = function () {
              ...
              if ((e && (m = !0), m)) return (p = (0, h.default)(p, f)), (0, u.default)(p, f.once), p;
            },
            b = function () {
              (p = (0, d.default)()), g();
            };
            ...
            init: function (e) {
              ...
              return (function (e) {
                ...
                : (f.disableMutationObserver ||
                  ...
                  "DOMContentLoaded" === f.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1
                    ? g(!0)
                    : "load" === f.startEvent
        ...
        function (e, t) {
          (function (t) {
            ...
            function i(e, t, i) {
              ...
              return (
                (t = o(t) || 0),
                s(i) && ((k = !!i.leading), (m = (T = "maxWait" in i) ? v(o(i.maxWait) || 0, t) : m), (E = "trailing" in i ? !!i.trailing : E)),
                (h.cancel = function () {
                  void 0 !== g && clearTimeout(g), (y = 0), (d = b = p = g = void 0);
                }),
                (h.flush = function () {
            ...
            function o(e) {
              ...
              e = e.replace(u, "");
              var i = d.test(e);
              return i || p.test(e) ? m(e.slice(2), i ? 2 : 8) : h.test(e) ? l : +e;
            }
            var r =
        ...
        function (e, t) {
          (function (t) {
            ...
            function n(e) {
              ...
              e = e.replace(c, "");
              var n = h.test(e);
              return n || d.test(e) ? p(e.slice(2), n ? 2 : 8) : u.test(e) ? a : +e;
            }
            var o =
                "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                  ? function (e) {
            ...
            e.exports = function (e, t, s) {
              ...
              return (
                (t = n(t) || 0),
                i(s) && ((k = !!s.leading), (m = (T = "maxWait" in s) ? y(n(s.maxWait) || 0, t) : m), (E = "trailing" in s ? !!s.trailing : E)),
                (h.cancel = function () {
                  void 0 !== g && clearTimeout(g), (_ = 0), (d = b = p = g = void 0);
                }),
                (h.flush = function () {
          ...
          t.default = {
            ...
            ready: function (e, t) {
              var o = window.document,
                r = new (i())(s);
              (n = t), r.observe(o.documentElement, { childList: !0, subtree: !0, removedNodes: !0 });
            },
          };
        },
        function (e, t) {
                        ...
                        !0 !== this.pause.status
                          ? (this.timeout = setTimeout(function () {
                              ...
                              i.timeout = setTimeout(function () {
                                i.toggleBlinking(!1),
                                  t >= e.length ? i.doneTyping(e, t) : i.keepTyping(e, t, n),
                        ...
                        if (!0 !== this.pause.status) {
                          ...
                          this.timeout = setTimeout(function () {
                            ...
                            if ((i.replaceText(s), i.smartBackspace)) {
                              ...
                              n && s === n.substr(0, t) ? (i.stopNum = t) : (i.stopNum = 0);
                            }
                            t > i.stopNum
                              ? (t--, i.backspace(e, t))
                              : t <= i.stopNum &&
                                ...
                                i.arrayPos === i.strings.length
                                  ...
                                  : i.typewrite(i.strings[i.sequence[i.arrayPos]], t));
                          }, s);
                        ...
                        this.cursor &&
                          (this.pause.status ||
                            (this.cursorBlinking !== e &&
                              ((this.cursorBlinking = e), e ? this.cursor.classList.add("typed-cursor--blink") : this.cursor.classList.remove("typed-cursor--blink"))));
                      },
                    },
                    {
                      key: "humanizer",
                  ...
                  i(e, [
                    {
                      ...
                      value: function (e, t, i) {
                        ...
                        if ("<" === s || "&" === s) {
                          var n = "";
                          for (n = "<" === s ? ">" : ";"; e.substr(t + 1).charAt(0) !== n && !(1 + ++t > e.length); );
                          t++;
                        }
                        return t;
                      },
                    },
                    {
                      ...
                      value: function (e, t, i) {
                        ...
                        if (">" === s || ";" === s) {
                          var n = "";
                          for (n = ">" === s ? "<" : "&"; e.substr(t - 1).charAt(0) !== n && !(--t < 0); );
                          t--;
                        }
                        return t;
                      },
